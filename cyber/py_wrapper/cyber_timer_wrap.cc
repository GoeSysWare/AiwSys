...
PyObject* cyber_new_PyTimer(PyObject* self, PyObject* args) {
  ...
  callback_fun = (void (*)())PyLong_AsLong(pyobj_regist_fun);
...
static struct PyModuleDef cyber_timer =
{
    PyModuleDef_HEAD_INIT,
    "_cyber_timer", /* name of module */
    "",          /* module documentation, may be NULL */
    -1,          /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    _cyber_timer_methods
};

PyMODINIT_FUNC PyInit__cyber_timer(void)
{
   AINFO << "init _cyber_timer";
    return PyModule_Create(&cyber_timer);
}
