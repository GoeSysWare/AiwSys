...
PyObject* cyber_PyParameter_type_name(PyObject* self, PyObject* args) {
  ...
  return PyBytes_FromStringAndSize(type.c_str(), type.size());
}
...
PyObject* cyber_PyParameter_descriptor(PyObject* self, PyObject* args) {
  ...
  return PyBytes_FromStringAndSize(desc.c_str(), desc.size());
}
...
PyObject* cyber_PyParameter_name(PyObject* self, PyObject* args) {
  ...
  return PyBytes_FromStringAndSize(name.c_str(), name.size());
}
...
PyObject* cyber_PyParameter_debug_string(PyObject* self, PyObject* args) {
  ...
  return PyBytes_FromStringAndSize(strTemp.c_str(), strTemp.size());
}
...
static struct PyModuleDef cyber_parameter =
{
    PyModuleDef_HEAD_INIT,
    "_cyber_parameter", /* name of module */
    "",          /* module documentation, may be NULL */
    -1,          /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    _cyber_parameter_methods
};

PyMODINIT_FUNC PyInit__cyber_parameter(void)
{
   AINFO << "init _cyber_parameter";
    return PyModule_Create(&cyber_parameter);
}