...
PyObject *cyber_PyReader_read(PyObject *self, PyObject *args) {
  ...
  return PyBytes_FromStringAndSize(reader_ret.c_str(), reader_ret.size());
}
...
PyObject *cyber_PyReader_register_func(PyObject *self, PyObject *args) {
  ...
  apollo::cyber::PyReader *reader = PyObjectToPtr<apollo::cyber::PyReader *>(
      pyobj_reader, "apollo_cyber_pyreader");
  callback_fun = (int (*)(const char *i))PyLong_AsLong(pyobj_regist_fun);
  if (reader) {
...
PyObject *cyber_PyClient_send_request(PyObject *self, PyObject *args) {
  ...
  return PyBytes_FromStringAndSize(response_str.c_str(), response_str.size());
}
...
PyObject *cyber_PyChannelUtils_get_msg_type(PyObject *self, PyObject *args) {
  ...
  std::string msg_type =
      apollo::cyber::PyChannelUtils::get_msgtype_by_channelname(channel,
                                                                sleep_s);
  return PyBytes_FromStringAndSize(msg_type.c_str(), msg_type.size());
}
...
PyObject *cyber_PyChannelUtils_get_debugstring_by_msgtype_rawmsgdata(
  ...
  std::string debug_string =
      apollo::cyber::PyChannelUtils::get_debugstring_by_msgtype_rawmsgdata(
          msgtype, raw_data);
  return PyBytes_FromStringAndSize(debug_string.c_str(), debug_string.size());
}
...
PyObject *cyber_PyNodeUtils_get_node_attr(PyObject *self, PyObject *args) {
  ...
  return PyBytes_FromStringAndSize(node_attr.c_str(), node_attr.size());
}
...
PyObject *cyber_PyServiceUtils_get_service_attr(PyObject *self,
  ...
  return PyBytes_FromStringAndSize(srv_attr.c_str(), srv_attr.size());
}
/////////////////////////////////////////////////////////////////////
//// debug pyobject
/////////////////////////////////////////////////////////////////////
...
PyObject *cyber_test0(PyObject *self, PyObject *args) {
  ...
  return PyBytes_FromStringAndSize(ret_str.c_str(), ret_str.size());
}
...
static struct PyModuleDef cyber_node =
{
    PyModuleDef_HEAD_INIT,
    "_cyber_node", /* name of module */
    "",          /* module documentation, may be NULL */
    -1,          /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    _cyber_node_methods
};

PyMODINIT_FUNC PyInit__cyber_node(void)
{
   AINFO << "init _cyber_node";
    return PyModule_Create(&cyber_node);
}