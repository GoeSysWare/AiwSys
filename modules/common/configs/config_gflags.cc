...
DEFINE_string(map_dir, "/home/shuimujie/01.works/AutoSys/modules/map/data/demo",
...
DEFINE_string(vehicle_config_path,
              "/home/shuimujie/01.works/AutoSys/modules/common/data/vehicle_param.pb.txt",
              "the file path of vehicle config file");

DEFINE_string(
    vehicle_model_config_filename,
    "/home/shuimujie/01.works/AutoSys/modules/common/vehicle_model/conf/vehicle_model_config.pb.txt",
