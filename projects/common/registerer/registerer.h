...
#define PROJECTS_REGISTER_REGISTERER(base_class)                    \
  class base_class##Registerer {                                      \
    typedef ::aiwsys::projects::common::Any Any;                       \
    typedef ::aiwsys::projects::common::FactoryMap FactoryMap;         \
                                                                      \
   public:                                                            \
    static base_class *GetInstanceByName(const ::std::string &name) { \
      FactoryMap &map =                                               \
          ::aiwsys::projects::common::GlobalFactoryMap()[#base_class]; \
...
#define PROJECTS_REGISTER_CLASS(clazz, name)                                \
  namespace {                                                                 \
  class ObjectFactory##name : public ::aiwsys::projects::common::ObjectFactory { \
   public:                                                                    \
    virtual ~ObjectFactory##name() {}                                         \
    virtual ::aiwsys::projects::common::Any NewInstance() {                    \
      return ::aiwsys::projects::common::Any(new name());                      \
    }                                                                         \
  };                                                                          \
  __attribute__((constructor)) void RegisterFactory##name() {                 \
    ::aiwsys::projects::common::FactoryMap &map =                              \
        ::aiwsys::projects::common::GlobalFactoryMap()[#clazz];                \
