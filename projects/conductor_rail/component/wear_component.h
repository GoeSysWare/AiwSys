...
#include "projects/conductor_rail/proto/rail.pb.h"
...
class WearDetectionComponent : public apollo::cyber::Component<> {
 public:
  WearDetectionComponent() : seq_num_(0) {}
  ~WearDetectionComponent();

  WearDetectionComponent(const WearDetectionComponent&) =
      delete;
  WearDetectionComponent& operator=(
      const WearDetectionComponent&) = delete;
